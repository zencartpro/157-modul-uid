...
define('MODULE_ORDER_TOTAL_VAT_REVERSE_CHARGES_TITLE_ADMIN', 'Hinweis auf innergemeinschaftliche Lieferung');
define('MODULE_ORDER_TOTAL_VAT_REVERSE_CHARGES_TITLE', 'steuerfreie innergemeinschaftliche Lieferung | Unsere UID: '. $storeuid . ' | Ihre UID: '. $customeruid . '');
define('MODULE_ORDER_TOTAL_VAT_REVERSE_CHARGES_DESCRIPTION', 'Bestandteil des UID Moduls. Muss aktiviert werden, damit in Bestellbestätigung und Rechnung ein Hinweis auf die umsatzsteuerfreie innergemeischaftliche Lieferung angezeigt wird.');
