...
if (isset($_SESSION['admin_id'])) {
    ...
    if (!defined('VAT4EU_MODULE_VERSION')) {
       ...
       ('UID - Überprüfung', 'VAT4EU_VALIDATION', 'Eine <em>UID</em> muss validiert werden, bevor dem Kunden eine Mehrwertsteuererstattung gewährt werden kann. Wählen Sie die Überprüfungsmethode für Ihren Shop, entweder:<br><br><b>Kunde</b> ... bei jeder Kundenaktualisierung validieren<br><b>Admin</b> ... nur durch Admin-Aktion validieren.<br>', 43),
